...
echo "change here"
df -T /data/models/VAE-approx/
#rsync --no-owner --no-group --no-perms --ignore-existing --no-D --omit-dir-times \
#               -a --info=NAME ${ROOT}/models/VAE-approx/ /data/models/VAE-approx/
#rsync --no-owner --no-group --no-perms --ignore-existing --no-D --omit-dir-times \
#       -a --info=NAME ${ROOT}/models/karlo/ /data/models/karlo/
cp -r ${ROOT}/models/VAE-approx/ /data/models/VAE-approx/
cp -r ${ROOT}/models/karlo/ /data/models/karlo/
